...
export default function Navigation() {
  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 backdrop-blur-md bg-white/70 dark:bg-black/50 border-b border-white/20 shadow-sm transition-all duration-300 ${
        scrolled ? "py-0" : "py-1"
      }`}
    >
